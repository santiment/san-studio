...
export declare function newMetricSettingsStore(defaultValue?: MetricSettings): {
  subscribe: (
    this: void,
    run: import('svelte/store').Subscriber<MetricSettings>,
    invalidate?: ((value?: MetricSettings | undefined) => void) | undefined,
  ...
  update(
    ...
    transformer?: (_: Studio.Metric, __: MetricSetting, ___: Studio.Metric[]) => MetricSetting,
  ): void
}
declare global {
