<script lang="ts">
  import HexInput from './HexInput.svelte' // TODO: Refactor and move to san-webkit [@vanguard | Jun 16, 2021]
  ...
  function newMouseHandler(moveHandler) {
    return (e) => {
      ...
      const clientRect =
        (_a = e.currentTarget) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect()
