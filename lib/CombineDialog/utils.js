import { getIntervalMilliseconds, normalizeInterval } from './../../lib/utils/intervals'
import { dataAccessor } from './../../lib/api/timeseries'
import { queryMetric } from './../../lib/api/timeseries/queries'
import { getMetricMinInterval } from './../../lib/api/metrics/restrictions'
import { newKey } from './../../lib/metrics/utils'
import { parseMetricKey } from './../../lib/sharing/metrics'
...
function fetch(variables, metric, cachePolicy) {
  ...
  const queries = baseMetrics.map(({ key, queryKey = key, reqMeta }) =>
    minIntervalPromise
      .then((minInterval) =>
        queryMetric(
          Object.assign(Object.assign({}, variables), {
            slug:
              (reqMeta === null || reqMeta === void 0 ? void 0 : reqMeta.slug) || variables.slug,
            metric: queryKey,
            key: COMBINED_KEY,
            interval: normalizeInterval(variables.interval || '', minInterval),
            label_fqn: reqMeta === null || reqMeta === void 0 ? void 0 : reqMeta.label_fqn,
          }),
          undefined,
          cachePolicy,
        ),
