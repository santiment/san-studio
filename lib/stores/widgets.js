...
import { getStudioContext, setStudioContext } from './../context.js';
...
export const setWidgets = (widgets) => setStudioContext(WIDGETS_CONTEXT, widgets);
export const getWidgets = () => getStudioContext(WIDGETS_CONTEXT);
...
export const setSidewidget = (sidewidget) => setStudioContext(SIDEWIDGET_CONTEXT, sidewidget);
