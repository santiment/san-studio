...
export declare type RawTimeseries = SAN.API.Query<
  'getMetric',
  {
    timeseriesData: {
      d: string
...
export declare type Timeseries = SAN.API.Query<
  'getMetric',
  {
...
export declare function queryMetric(
  variables: Variables,
  precacher?: (variables: Variables) => any,
