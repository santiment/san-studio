...
export const querySignalTimeseries = (signal, { slug, from, to, interval }) => query(SIGNAL_QUERY, {
...
export const queryRawSignal = (slug, from, to) => query(RAW_SIGNAL_QUERY(slug, from, to), { precacher: rawPrecacher });
