...
function mutateLayoutsCacheOnUpdate(newLayout) {
  ...
  const updateLayout = (cachedLayout) =>
...
export const updateUserLayout = (id, settings) =>
...
export const createUserLayout = (settings) =>
  mutate(CREATE_LAYOUT_MUTATION, {
...
export const deleteUserLayout = (id) =>
