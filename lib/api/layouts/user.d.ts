/// <reference types="./api" />
declare type CurrentUserQuery<T> = SAN.API.Query<
  'currentUser',
  null | {
    layouts: T[]
  }
...
export declare const updateCurrentUserLayoutsCache: (
  updateCache: SAN.API.Updater<CurrentUserLayoutsQuery>,
) => void
export declare const subscribeCurrentUserLayoutsCache: (
  clb: SAN.API.Subscriber<CurrentUserLayoutsQuery>,
...
export declare const updateCurrentUserShortLayoutsCache: (
  updateCache: SAN.API.Updater<CurrentUserShortLayoutsQuery>,
) => void
export declare const subscribeCurrentUserShortLayoutsCache: (
  clb: SAN.API.Subscriber<CurrentUserShortLayoutsQuery>,
) => SAN.API.Unsubscriber
export {}
