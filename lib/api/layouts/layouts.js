...
`
export const queryFeaturedShortLayouts = () =>
  query(FEATURED_SHORT_LAYOUTS_QUERY).then(layoutsAccessor)
export const queryShortLayouts = (slug) =>
  query(SHORT_LAYOUTS_QUERY(slug), sortableLayoutsOptions).then(layoutsAccessor)
// -----------------------------
// ------ PROJECT LAYOUTS ------
// -----------------------------
...
`
export const queryLayouts = (slug) =>
  query(PROJECT_LAYOUTS_QUERY(slug), sortableLayoutsOptions).then(layoutsAccessor)
