...
declare function dataSorter<T extends Sortable>(data: SAN.API.Query<'layouts', T[]>): SAN.API.Query<"layouts", T[]>;
export declare const sortableLayoutsOptions: {
    precacher: () => typeof dataSorter;
};
declare function currentUserDataSorter<T extends Sortable>(data: SAN.API.Query<'currentUser', null | {
    layouts: T[];
}>): SAN.API.Query<"currentUser", {
    layouts: T[];
} | null>;
