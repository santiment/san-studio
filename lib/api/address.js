...
export const queryNftCollection = (address, infrastructure) =>
  query(NFT_COLLECTION_QUERY(address, infrastructure)).then(nftCollectionAccessor)
export const checkIsNftAddress = (labels) =>
...
export const queryAddressLabels = (address, infrastructure) =>
  query(ADDRESS_LABELS_QUERY(address, infrastructure)).then(labelsAccessor)
