...
const precacher = () => ({ hq, pq }) => {
    var _a;
    return ({
        buckets: ((_a = hq.histogramData.values.data) === null || _a === void 0 ? void 0 : _a.map(bucketsMap)) || [],
        price: pq.v,
    });
};
const options = { precacher };
export const queryPriceHistogram = (slug, from, to) => query(HISTOGRAM_DATA_QUERY(slug, from, to), options);
