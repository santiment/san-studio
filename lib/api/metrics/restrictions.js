...
export const queryMinInterval = () => query(MIN_INTERVAL_QUERY, options)
export const getMetricKeyMinInterval = (metricKey) =>
  queryMinInterval().then((MetricMinInterval) => {
    var _a
    return (_a = MetricMinInterval[metricKey]) === null || _a === void 0 ? void 0 : _a.minInterval
  })
