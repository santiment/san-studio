import { MetricIndex } from './../../../lib/metrics'
...
const indexSorter = (a, b) => (MetricIndex[a] || -1) - (MetricIndex[b] || -1)
...
export const checkIsFilterMatch = (searchTerm, { label, title, group, shorthand }) =>
