...
export const Metric = each(Object.assign({}, FinancialMetric, SocialMetric, DevelopmentMetric, DerivativesMetric, IndicatorsMetric, OnChainMetric), (metric, key, i) => {
    metric.key = key;
...
Object.assign(Metric, MvrvTimebounds, MvrvUsdIntradayTimebounds, RealizedCapTimebounds, CirculationTimebounds, DormantCirculationTimebounds, MeanAgeTimebounds, MeanDollarInvestedAgeTimebounds, Eth2StakersRealizedTimebounds, Eth2StakersMvrvTimebounds);
