...
import { AaveMetric, Aave3Metric, AaveSafetyModuleMetric } from './aave.js';
...
import { CrvUSDSavingsMetric } from './crvusdSavings.js';
...
}, XrpMetric, ContractAddressMetric, FeesMetric, Eth2Metric, AaveSafetyModuleMetric, AaveMetric, Aave3Metric, CompoundMetric, Compound3Metric, MakerDaoMetric, MakerDaoDsrMetric, SparkMetric, FluidMetric, MorphoMetric, LiquityMetric, FraxlendMetric, EthenaMetric, SkySavingsMetric, CrvUSDSavingsMetric, PendleMarketsMetric, BeaconMetric, NFTMetric, DefiMetric, HolderDistributionMetric, LongTermHoldersMetric, NetworkActivityMetric, NetworkValueMetric), (metric) => (metric.category = MetricCategory.OnChain));
