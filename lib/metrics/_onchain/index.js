...
import { MakerDaoMetric } from './makerDao.js';
...
import { usdFormatter, mvrvFormatter, ratioPercentAxisFormatter, ratioPercentForamtter, } from './../../metrics/formatters.js';
...
}, XrpMetric, ContractAddressMetric, FeesMetric, ExchangesMetric, ExchangesV2Metric, Eth2Metric, AaveMetric, Aave3Metric, CompoundMetric, Compound3Metric, LiquityMetric, BeaconMetric, NFTMetric, DefiMetric, HolderDistributionMetric, LongTermHoldersMetric, NetworkActivityMetric, NetworkValueMetric, MakerDaoMetric), (metric) => (metric.category = MetricCategory.OnChain));
