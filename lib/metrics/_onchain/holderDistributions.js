...
import { percentFormatter, axisPercentFormatter } from './../../metrics/formatters.js';
...
export const HolderDistributionBalancePercentMetric = buildMetrics(HOLDERS_DISTRUBTION_PERCENT, 'percent', ' %', percentFormatter, axisPercentFormatter);
...
export const HoldersLabeledDistributionMetric = buildMetrics(HOLDERS_LABELED_DISTRIBUTION, undefined, undefined, undefined, undefined, 
// HACK: Until backend architecture [@vanguard | Jun 30, 2021]
{ interval: '1d', aggregation: 'SUM' });
export const HolderDistributionMetric = Object.assign(Object.assign(Object.assign(Object.assign({}, HolderDistributionAbsoluteMetric), HolderDistributionBalancePercentMetric), HolderDistributionBalanceAbsoluteMetric), HoldersLabeledDistributionMetric);
...
export const HOLDER_DISTRIBUTION_BALANCE_ABSOLUTE_METRICS = Object.values(HolderDistributionBalanceAbsoluteMetric);
export const HOLDER_DISTRIBUTION_BALANCE_PERCENT_METRICS = Object.values(HolderDistributionBalancePercentMetric);
export function getType(key) {
    if (key.startsWith(HOLDERS_DISTRUBTION_PERCENT))
        return HOLDERS_DISTRUBTION_PERCENT;
    if (key.startsWith(HOLDERS_DISTRUBTION_COMBINED))
        return HOLDERS_DISTRUBTION_COMBINED;
    if (key.startsWith(HOLDERS_LABELED_DISTRIBUTION))
        return HOLDERS_LABELED_DISTRIBUTION;
