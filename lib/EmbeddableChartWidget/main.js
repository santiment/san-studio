...
import App from './../../lib/EmbeddableChartWidget/WithApi.svelte'
import { studio } from './../../lib/stores/studio'
import { globals } from './../../lib/stores/globals'
import { newWidget } from './../../lib/stores/widgets'
import { parseQueryString } from './../../lib/ChartWidget/Controls/Embed/utils'
const _a = parseQueryString(
  ...
  { from, to, slug, ticker, isNightMode, isWithMetricSettings } = _a,
  widgetProps = __rest(_a, ['from', 'to', 'slug', 'ticker', 'isNightMode', 'isWithMetricSettings'])
