...
export const shareAxesMetrics = (axesMetrics, accessor = keyAccessor) => normalizeIds(Array.from(axesMetrics || []).map(accessor));
export const shareColors = (colors, metricAlias) => eachAlias(Object.keys(colors || {}), metricAlias, (key) => colors[key]);
