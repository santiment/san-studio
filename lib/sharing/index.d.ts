...
export declare function eachAlias<T>(keys: string[], metricAlias: MetricAlias, clb: (metricKey: string) => T): T[];
export declare const shareAxesMetrics: (axesMetrics: Metric[] | undefined, accessor?: ({ key }: Metric) => string) => string[];
export declare const shareColors: (colors: {
    [metricKey: string]: string;
}, metricAlias: MetricAlias) => string[];
export declare function shareMetricSettings(settings: {
    [metricKey: string]: any;
}, metricAlias: MetricAlias): (undefined | {
    [alias: string]: any;
})[];
