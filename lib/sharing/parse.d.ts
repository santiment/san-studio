...
export declare function parseMetrics(
  metricKeys: undefined | string[],
  KnownMetric: KeyToMetric,
): BaseMetricType[]
export declare function parseCombinedMetrics(
  metrics:
    | undefined
    | {
        k: string
...
export declare function parseAxesMetrics(
  ...
  | undefined
export declare function parsePinnedAxesMetrics(
  metricIds: undefined | string[],
  metrics: any[],
): Set<any> | undefined
