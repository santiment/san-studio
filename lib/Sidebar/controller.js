...
import { selectedItems } from './../stores/selector/index.js';
import { SelectorType } from './../metrics/selector/types.js';
import { newProjectMetric } from './../metrics/utils.js';
import { Node } from './../Chart/nodes.js';
import { Metric as M } from './../metrics/index.js';
...
export function handleItemSelect(item, e, Widgets, Sidewidget, History, adjustSelectedMetric) {
    ...
    if (!widget)
        return selectedItems.toggle(item);
    ...
    metric = (adjustSelectedMetric === null || adjustSelectedMetric === void 0 ? void 0 : adjustSelectedMetric(metric)) || metric;
    ...
    if (e.shiftKey) {
        ...
        History === null || History === void 0 ? void 0 : History.add('New widget', () => { var _a; return (_a = widget.delete) === null || _a === void 0 ? void 0 : _a.call(widget); }, () => ((widget.scrollOnMount = true), Widgets.push(widget)));
        return;
    }
    ...
    redo();
    History === null || History === void 0 ? void 0 : History.add('Add metrics', withScroll(widget, () => (Metrics.set(oldMetrics), MetricsSignals.set(oldSignals))), withScroll(widget, redo));
}
