...
export function getPadding(chart, axesMetricKeys) {
    ...
    return Object.assign(Object.assign({}, padding), { bottom: padding.bottom > X_MARGIN ? padding.bottom : X_MARGIN, right: axesLength * MULTI_AXIS_WIDTH + (axesLength ? rightAxisMargin : 3) });
}
...
export function getMetricAxisFormatter(metricSettings, key) {
    var _a;
    return ((_a = metricSettings[key]) === null || _a === void 0 ? void 0 : _a.axisFormatter) || yAxisFormatter;
}
...
export function plotMetricLastValueBubble(chart, metricKey, metricSettings, LastMetricPoint, offset, color) {
