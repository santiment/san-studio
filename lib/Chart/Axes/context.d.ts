...
export declare function newChartAxesStore(
  defaultEnabled?: Set<Studio.Metric>,
  defaultDisabled?: Set<Studio.Metric>,
): {
  subscribe: (
    this: void,
    run: import('svelte/store').Subscriber<Set<Studio.Metric>>,
    invalidate?: ((value?: Set<Studio.Metric> | undefined) => void) | undefined,
