...
import { paintDrawings } from './drawings/index.js';
import { resetRatioCoordinates, resetRelativeCoordinates, resetAbsoluteCoordinates, setupDrawingsCoordinatesUpdater, } from './coordinates.js';
...
export function newDrawer(chart, onSelectionChange) {
    ...
    drawer.redraw = () => { var _a; return (paintDrawings(chart), (_a = drawer.drawSelection) === null || _a === void 0 ? void 0 : _a.call(drawer)); };
    chart.drawer = drawer;
...
function newDrawerUpdater({ width, height }, onSelectionChange) {
    ...
    return (chart) => {
        ...
        const isNewMinMax = Number.isFinite(min) &&
            Number.isFinite(max) &&
...
function newChangedDatetimesChecker() {
    ...
    return (data) => {
        ...
        if (left === datetimes[0] && right === datetimes[1])
            return false;
        datetimes[0] = left;
        datetimes[1] = right;
        return true;
