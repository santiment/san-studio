import { newDrawing, newRoundHandle, checkIsOnStrokeArea, getEventCoordinates } from '../utils.js';
...
export const getLineLockType = (x1, y1, x2, y2) => Math.abs(x2 - x1) < Math.abs(y2 - y1) ? LineLockType.X : LineLockType.Y;
export function lineDragModifier(drawing, initialAbsCoor, [isLeftHandleDrag, isRightHandleDrag, isNotLineDrag], xDiff, yDiff, e) {
