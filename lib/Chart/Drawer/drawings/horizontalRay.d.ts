...
export declare function paintHorizontalRay(
  chart: SAN.Charts.Chart,
  drawing: SAN.Charts.HorizontalRay,
): void
export declare function updateHorizontalRay(
  { left, right }: SAN.Charts.Chart,
  drawing: SAN.Charts.HorizontalRay,
): void
export declare function checkHorizontalRayIsHovered(
  ctx: CanvasRenderingContext2D,
  drawing: SAN.Charts.HorizontalRay,
  mouseXY: [number, number],
  dpr: number,
): boolean
export declare function paintHorizontalRayHover(
  { drawer, theme }: SAN.Charts.Chart,
  drawing: SAN.Charts.HorizontalRay,
): void
export declare function horizontalRayDragModifier(
  drawing: SAN.Charts.HorizontalRay,
...
export declare function newHorizontalRayCreationHandler(
  chart: SAN.Charts.Chart,
