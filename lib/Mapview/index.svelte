<script lang="ts">
  ...
  function onWidgetClick(widget, e) {
    ...
    if (widget.Metrics) {
      ...
      if (
        (e === null || e === void 0 ? void 0 : e.ctrlKey) ||
        (e === null || e === void 0 ? void 0 : e.metaKey)
      )
        return
      selectedItems.clear()
    }
  ...
  function onNewWidgetClick({ ctrlKey, metaKey }) {
    ...
    History.add(
      'New widget',
      () => (widget === null || widget === void 0 ? void 0 : widget.delete()),
      () => {
...
{#if isMapview}
  <Grid {isMetricsPhase} {widgets} let:hiddenWidgets>
    ...
    {#if isMetricsPhase && $selectedItems.metrics.length}
      <Preview class="column hv-center body-2 txt-m new-Dc9pZd" on:click={onNewWidgetClick}>
...
<style>
  ...
  :global(.column.new-Dc9pZd) {
    color: var(--waterloo);
    border: 1.5px dashed var(--mystic);
  }
  :global(.column.new-Dc9pZd::after) {
    display: none !important;
  }
  :global(.column.new-Dc9pZd:hover) {
